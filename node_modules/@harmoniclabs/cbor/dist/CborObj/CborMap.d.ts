import { CborObj, RawCborObj } from "./index.js";
...
export declare function isRawCborMap(m: RawCborMap): boolean;
export type CborMapEntry = {
    k: CborObj;
    v: CborObj;
};
export declare class CborMap implements ToRawObj, ICborObj {
    subCborRef?: SubCborRef | undefined;
    readonly map: CborMapEntry[];
    readonly indefinite: boolean;
    addInfos: number;
    constructor(map: CborMapEntry[], options?: CborMapOptions, subCborRef?: SubCborRef | undefined);
    toRawObj(): RawCborMap;
    clone(): CborMap;
}
