...
export declare const defaultParseOptions: ParseOptions;
/**
...
export declare class Cbor {
    ...
    static parse(cbor: CborString | Uint8Array | string, parseOpts?: ParseOptions): CborObj;
    static parseWithOffset(cbor: CborString | Uint8Array | string, parseOpts?: ParseOptions): {
        parsed: CborObj;
        offset: number;
    };
